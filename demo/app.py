...
.impact-cell:hover { background: rgba(34, 197, 94, 0.06); }
.impact-num {
    font-family: 'IBM Plex Mono', monospace;
...
/* STREAMLIT BUTTON OVERRIDES (The "Red/Green" High Visibility Look) */
...
<div class="hero">
    ...
    <p class="hero-sub">The UK's first carbon-aware ML scheduling platform. Reduce emissions by up to 70% using real-time Grid forecasting.</p>
</div>
""", unsafe_allow_html=True)
...
with c2:
    ...
    with b2:
        st.page_link("pages/simulation.py", label="SIMULATION LAB", icon="🧪")
...
<div class="impact-strip">
    ...
    <div class="impact-cell"><span class="impact-num">24 / 7</span><span class="impact-label">Live Monitoring</span></div>
...
with m1:
    st.markdown('<div class="module-card-ui"><h3>⚡ Scheduler</h3><p style="color:#94a3b8; font-size:14px;">Optimal low-carbon execution windows.</p></div>', unsafe_allow_html=True)
    st.page_link("pages/overview.py", label="Open Scheduler")
with m2:
    st.markdown('<div class="module-card-ui"><h3>📡 API</h3><p style="color:#94a3b8; font-size:14px;">Real-time National Grid ESO carbon data.</p></div>', unsafe_allow_html=True)
    st.page_link("pages/overview.py", label="View API")
with m3:
    st.markdown('<div class="module-card-ui"><h3>🤖 RL Lab</h3><p style="color:#94a3b8; font-size:14px;">Training agents for carbon uncertainty.</p></div>', unsafe_allow_html=True)
    st.page_link("pages/simulation.py", label="Enter Lab")
...
<div class="site-footer">
    <div class="footer-l"><span>CARBONML</span> · Built by Sufiyan Ul Rehman</div>
    <div class="footer-l" style="font-size:10px; color:#475569;">UK NET ZERO 2050 ALIGNED</div>
</div>
""", unsafe_allow_html=True)