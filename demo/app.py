...
.hero-sub {
    color:#94a3b8; /* Enhanced contrast from slate-500 to slate-400 */
    font-size:18px;
    line-height:1.8;
    max-width:700px;
    margin:auto;
...
.impact-label {
    color:#cbd5e1; /* Brighter Silver/Gray */
    font-size:12px;
    margin-top:8px;
...
<div class="hero">
    ...
    <h1>Schedule ML workloads at<br><span class="hero-green">peak carbon efficiency</span></h1>
    <div class="hero-sub">
...
with c2:
    ...
    with b2:
        if st.button("Simulation Lab", use_container_width=True):
            st.info("Redirecting to Simulation Lab...")
...
<div class="impact-row">
    <div class="impact-box">
        ...
        <div class="impact-label">Max CO₂ Reduction</div>
    </div>
    <div class="impact-box">
        <div class="impact-num">24/7</div>
        <div class="impact-label">Grid Monitoring</div>
    </div>
    <div class="impact-box">
        <div class="impact-num">RL</div>
        <div class="impact-label">Adaptive Agent</div>
    </div>
    <div class="impact-box">
...
<div class="section">
    ...
    <div class="section-sub">Three integrated systems working together in real time.</div>
    <div class="card-grid">
        <div class="card">
            <div style="font-size:28px; margin-bottom:15px;">⚡</div>
            <div class="card-title">Carbon Scheduler</div>
            <div class="card-desc">Identifies optimal low-carbon execution windows using 24-hour National Grid forecasting.</div>
        </div>
        <div class="card">
            <div style="font-size:28px; margin-bottom:15px;">📡</div>
            <div class="card-title">Carbon Intelligence API</div>
            <div class="card-desc">Real-time integration with National Grid ESO carbon data with high forecast accuracy.</div>
        </div>
        <div class="card">
            <div style="font-size:28px; margin-bottom:15px;">🤖</div>
            <div class="card-title">RL Simulation Lab</div>
            <div class="card-desc">Reinforcement learning agent learns optimal execution timing under carbon uncertainty.</div>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="footer">
    <div>CARBONML · Carbon-Aware AI Systems · Built by Sufiyan Ul Rehman</div>
    <div>Aligned with UK Net Zero 2050</div>
</div>
""", unsafe_allow_html=True)